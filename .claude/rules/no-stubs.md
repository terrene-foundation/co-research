...
These rules apply to all research documents and publications.
...
Research documents SHOULD NOT contain:
...
- If a reference is cited, it should exist and be verifiable
- If a methodology is described, it should be complete enough to follow
...
Placeholder content in academic publications creates ambiguity. In a methodology section, an undefined process cannot be replicated. In a literature review, a vague reference cannot be verified.
