...
- **Shared-state changes visible to others**: pushing this repository to its remote, opening/closing/commenting on PRs or issues, posting to external services, modifying shared infrastructure or permissions, uploading content to third-party renderers.
...
Confirmation here is NOT hedging. It is the user's pre-declared safety check on actions whose blast radius they have not yet authorized — skipping it breaks the envelope this directive operates inside.
